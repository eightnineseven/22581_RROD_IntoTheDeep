...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "motor_ch_0";
    public static String leftRearMotorName = "motor_ch_1";
    public static String rightFrontMotorName = "motor_ch_2";
    public static String rightRearMotorName = "motor_ch_3";

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static double xMovement = 67.8067;
    private static double yMovement = 60.0342;
    ...
    public static double forwardZeroPowerAcceleration = -40.8026;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -54.0135;
