...
@Autonomous
public class FiveSpecVelocity extends CommandOpMode {
    ...
    public void initialize() {
        ...
        schedule(
                ...
                new FixedSequentialCommandGroup(
                        ...
                        new FollowPathCommand(follower, paths.getPath(1,follower),1),


                        //stops this flow until the robot is stopped in place
                        new WaitUntilCommand(() ->follower.getVelocity().getMagnitude()<1.2 && follower.getPose().getX()>25),
                        ...
                        new FollowPathCommand(follower, paths.getPath(3,follower),1),
                        actions.prep_score(mechs),
                        new WaitUntilCommand(() ->follower.getVelocity().getMagnitude()<0.8 && follower.getPose().getX()>25),
                        actions.lift_specimen_score(mechs),


                        new FollowPathCommand(follower, paths.getPath(4,follower),1),
                        actions.pre_wall_intake(mechs),
                        new WaitUntilCommand(() ->follower.getVelocity().getMagnitude()<0.8 && follower.getPose().getX()<25),
                        new WaitCommand(500),
                        actions.actual_wall_intake(mechs),
                        ...
                        new FollowPathCommand(follower, paths.getPath(5,follower),1),
                        actions.prep_score(mechs),
                        new WaitUntilCommand(() ->follower.getVelocity().getMagnitude()<0.8 && follower.getPose().getX()>25),
                        actions.lift_specimen_score(mechs),
                        ...
                        new FollowPathCommand(follower, paths.getPath(6,follower),1),
                        actions.pre_wall_intake(mechs),
                        new WaitUntilCommand(() ->follower.getVelocity().getMagnitude()<0.8 && follower.getPose().getX()<25),
                        new WaitCommand(500),
                        actions.actual_wall_intake(mechs),
                        ...
                        new FollowPathCommand(follower, paths.getPath(7,follower),1),
                        actions.prep_score(mechs),
                        new WaitUntilCommand(() ->follower.getVelocity().getMagnitude()<0.8 && follower.getPose().getX()>25),
                        actions.lift_specimen_score(mechs),

                        new FollowPathCommand(follower, paths.getPath(8,follower),1),
                        actions.pre_wall_intake(mechs),
                        new WaitUntilCommand(() ->follower.getVelocity().getMagnitude()<0.8 && follower.getPose().getX()<25),
                        new WaitCommand(500),
                        actions.actual_wall_intake(mechs),
                        ...
                        new FollowPathCommand(follower, paths.getPath(9,follower),1),
                        actions.prep_score(mechs),
                        new WaitUntilCommand(() ->follower.getVelocity().getMagnitude()<0.8 && follower.getPose().getX()>25),
                        actions.lift_specimen_score(mechs),
