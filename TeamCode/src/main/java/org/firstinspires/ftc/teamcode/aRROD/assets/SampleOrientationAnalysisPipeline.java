...
public class SampleOrientationAnalysisPipeline implements VisionProcessor {
    ...
    public static double PIXELS_PER_INCH = 0;
    ...
    public double getTurretAngle(){return Math.atan(xChange/yChange);}
    public double getSwivelAngle(){return angleOfSample;}
    public double getExtendoLength(){return yChange*PIXELS_PER_INCH;}
}
