...
public class PinpointLocalizer extends Localizer {
    ...
    public static double xOffset=3.75*24;
    public static double yOffset= 3.25*34;
    /**
    ...
    public PinpointLocalizer(HardwareMap map, Pose setStartPose){
        ...
        odo = hardwareMap.get(GoBildaPinpointDriver.class,"imu 1");
      ...
      //  odo.setYawScalar(1.0);
        ...
        odo.setEncoderResolution(19.89436789 * 0.985);
